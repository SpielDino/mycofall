...
func on_settings_save(data: Dictionary) -> void:
	var save_settings_data_file: FileAccess = FileAccess.open(SETTINGS_SAVE_PATH, FileAccess.WRITE)
	
	var json_data_string: String = JSON.stringify(data)
...
func load_settings_data() -> void:
	...
	var save_settings_data_file: FileAccess = FileAccess.open(SETTINGS_SAVE_PATH, FileAccess.READ)
